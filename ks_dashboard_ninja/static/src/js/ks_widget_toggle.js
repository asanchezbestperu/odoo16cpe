odoo.define('ks_dashboard_ninja.ks_widget_toggle', function (require) {
    "use strict";
    ...
    var KsWidgetToggle = AbstractField.extend({
        ...
        _render: function () {
            console.log("renderrrrrrrr KsWidgetToggle")
            var self = this;
            self.$el.empty();
    ...
    var KsWidgetToggleKPI = AbstractField.extend({
        ...
        _render: function () {
            console.log("renderrrrrrrr KsWidgetToggleKPI")
            var self = this;
            self.$el.empty();
    ...
    var KsWidgetToggleKpiTarget = AbstractField.extend({
        ...
        _render: function () {
            console.log("renderrrrrrrr KsWidgetToggleKpiTarget")
            var self = this;
            self.$el.empty();
