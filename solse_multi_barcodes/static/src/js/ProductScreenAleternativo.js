...
export const ProductScreenMultiBarcode = (ProductScreen) =>
					...
					try {
						...
						if (isConnectionError(error)) {
							return this.showPopup('OfflineErrorPopup', {
								title: "Error de red",
								body: "El producto no está cargado. Intenté cargar el producto desde el servidor pero hay un error de red.",
							});
						} else {
							throw error;
						}
